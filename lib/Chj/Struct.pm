...
If you add methods outside the scope of a module ("monkey patching"),
then be sure to do it after loading the module, so that _END_ has been
run, otherwise the method will be cleaned away.
